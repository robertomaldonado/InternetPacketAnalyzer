...
void inspect(char* streamedData);
void inspect2(char* streamedData);
void inspect3(char* streamedData);
...
int main(int argc, char *argv[])
{
    if (argc == 1){
        ...
        exit(1);
    }else if (argc == 2){  //If regular call, present a summary
        ...
        if( std::string(argv[2]) == "-c" ){
            ...
            printf("%d\n", limit);
            // Call the function with stop at the designated number of packets 
        }else{
...
void partialScan(string file_name, int marker)
{
 ...
 // Read data as a block:
        ...
        input_file.close();
        if(marker == 1){//Summary
            inspect2(  streamedData );
        }else if(marker == 2){//Detailed
            inspect(  streamedData );
        }else if(marker == 3){
            inspect3( streamedData );
        }
    ...
    while( inspectedBytes < stream_size ){ 
        ...
        if(ether_type == 2048){ //Decimal for 0x0800 (IP)
            ...
            if (is_broadcast == 0 && arp_opcode == 1 ){ //Not a broadcast
                ...
                arp_sender_protocol_1, arp_sender_protocol_2, arp_sender_protocol_3, arp_sender_protocol_4,
                arp_target_protocol_1, arp_target_protocol_2, arp_target_protocol_3, arp_target_protocol_4);                
            // }else if( is_broadcast == 1 && arp_opcode == 2 ){
            //     printf("%d.%d.%d.%d -> (broadcast) (ARP) %d.%d.%d.%d's hardware address is %x:%x:%x:%x:%x:%x\n",
            //     arp_sender_protocol_1, arp_sender_protocol_2, arp_sender_protocol_3, arp_sender_protocol_4,
            //     // arp_target_protocol_1, arp_target_protocol_2, arp_target_protocol_3, arp_target_protocol_4,
            //     arp_sender_protocol_1, arp_sender_protocol_2, arp_sender_protocol_3, arp_sender_protocol_4,
...
void printEtherPkt(int id, int size, long long dest, long long src, long ether_type){
    printf("ETHER:  ------ Ether Header ------  ");
    printf("ETHER:");
    printf("ETHER:  Packet size = %d bytes", id);    
    printf("ETHER:  Destination = (print in hex) ");
    printf("ETHER:  Source      = (print in hex) ");
    printf("ETHER:  Ethertype   = (print in hex) ");
    printf("ETHER:");
...
void printArpPkt(){
    printf("ARP: ------ ARP Frame ------  \n");
    printf("ARP:\n");
    //TO-DO: Validate content of parenthesis 
    printf("ARP:  Hardware type = 1 (Ethernet)\n");   
    //TO-DO: Validate content of parenthesis      
    printf("ARP:  Protocol type = (print in hex)(IP) \n");
    //TO-DO: Validate content of parenthesis      
    printf("ARP:  Length of hardware address = (6) bytes \n");
    //TO-DO: Validate content of parenthesis          
    printf("ARP:  Length of protocol address = (4) bytes \n");
    //TO-DO: Validate content of parenthesis          
    printf("ARP:  Opcode (1) (ARP Request)\n");
    //TO-DO: Validate content of parenthesis              
    printf("ARP:  Sender's hardware address = (hex)\n");
    //TO-DO: Validate content of parenthesis              
    printf("ARP:  Sender's protocol address = (dec)\n");
    //TO-DO: Validate content of parenthesis          
    printf("ARP:  Target hardware address = (?)\n");
    //TO-DO: Validate content of parenthesis          
    printf("ARP:  Target protocol address = (dec)\n");  
    //TO-DO: Validate content of parenthesis          
    printf("ARP:\n");
}
void printIpPkt(){
    ...
    printf("IP:  Total length = %d bytes\n");
    printf("IP:  Identification: 0\n");
    printf("IP:  Flags  \n");
    printf("IP:  .1.. .... = do not fragment\n");
    printf("IP:  ..0. .... = last fragment\n");   
    printf("IP:  Fragment offset: %d bytes\n");
    printf("IP:  Protocol = 1 (ICMP)\n");
    printf("IP:  Header Checksum = (print in hex) \n");
    printf("IP:  Source address = (in decimal)\n");
    printf("IP:  Destination address = (in decimal)\n");
    printf("IP:  No options \n");
    printf("IP:\n"); 
...
void printIcmpPkt(){
    ...
    printf("ICMP:  Code = %d\n");
    printf("ICMP:  Checksum = (print in hex)\n");
    printf("ICMP:  Identifier   = %d\n");
    printf("ICMP:\n");    
}
void printUdpPkt(){
    ...
    printf("UDP:  Source Port = %d\n");    
    printf("UDP:  Destination Port = %d\n");    
    printf("UDP:  Message lenght = %d\n");
    printf("UDP:  Checksum = (print in hex)\n");
    printf("UDP:\n");
}
void printTcpPkt(){
    printf("TCP:  ------ TCP Header ------  \n");
    ...
    printf("TCP:  Data Offset = %d bytes");
    printf("TCP:  Flags \n");
    printf("TCP:  ..0. .... = No urgent pointer\n");
    printf("TCP:  ...1 .... = Acknowledgement\n");
    printf("TCP:  .... 0... = No push\n");
    printf("TCP:  .... .0.. = No reset\n");
    printf("TCP:  .... ..0. = No Syn\n");
    printf("TCP:  .... ...0 = No Fin\n");
    printf("TCP:  Window = %d \n");
    printf("TCP:  Checksum = (print in hex)\n");
    printf("TCP: Urgent pointer = %d");
    printf("TCP:  ------ UDP Header ------  \n");
    printf("TCP:  Checksum = (print in hex)\n");
    printf("TCP:");
}
...
void printIntermediate(){
    //Print the unknow packet dest, src address.
    printf("unknown packet (%02x:%02x:%02x:%02x:%02x:%02x",(unsigned)(unsigned char) 'c',
                           (unsigned)(unsigned char) 'c', (unsigned)(unsigned char) 'c',
                           (unsigned)(unsigned char) 'c', (unsigned)(unsigned char) 'c',
                           (unsigned)(unsigned char) 'c' );
    printf(", %02x:%02x:%02x:%02x:%02x:%02x",(unsigned)(unsigned char) 'c',
                           (unsigned)(unsigned char) 'c', (unsigned)(unsigned char) 'c',
                           (unsigned)(unsigned char) 'c', (unsigned)(unsigned char) 'c',
                           (unsigned)(unsigned char) 'c' );
    printf(", 0:%02x)\n",(unsigned)(unsigned char) 'c' );

    //In case of ARP broadcast
    printf("%d.%d.%d.%d -> (broadcast) (ARP) who is %d.%d.%d.%d", 'c', 'c', 'c','c',
                                                    'c','c','c','c');
    //In case of ARP 
    printf("%d.%d.%d.%d -> %d.%d.%d.%d (ARP) who is %d.%d.%d.%d", 'c', 'c', 'c','c',
                                                    'c','c','c','c','c','c','c','c');
}